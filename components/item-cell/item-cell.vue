<template>
	<view class="container">
		<view class="bg_view_title">
			<view class="title">
				<text>第{{itemData.no}}期</text>
			</view>
			<view class="time">
				<text>{{itemData.date}} 21:15</text>
			</view>
		</view>
		<view class="bg_view_bottom">
			<view class="item_red_ball" v-for="(item, i) in itemData.redNums" v-bind:key="i">
				<text class="red_number" >{{item}}</text>
			</view>
